  ...
  return (
    <>
      <div className=" text-right">
        <button
          type="button"
          className="rounded-xl bg-cyan-900 px-5 py-2.5 text-center text-sm font-medium text-white"
          onClick={handleOpen}
        >
          Add User
        </button>
      ...
      {isModalOpen && (
        <div className="fixed left-0 right-0 top-0 z-50 h-[calc(100%-1rem)] max-h-full w-full overflow-y-auto overflow-x-hidden rounded-lg p-4 md:inset-0">
          <div className="relative mx-auto my-20 max-h-full max-w-md">
            <div className="relative mx-auto bg-white shadow-lg">
              ...
              <div className=" rounded-lg px-6 py-6 lg:px-8">
                ...
                <form className="space-y-6" action="#" onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="w-full rounded-lg bg-cyan-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-cyan-900 focus:outline-none focus:ring-4 focus:ring-blue-300"
                  >
                    Submit
                  </button>
                </form>
